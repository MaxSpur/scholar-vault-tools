...
- Skill sync selection should use one custom-select list, not duplicated direction lists or native row checkboxes. Deselecting all candidates must disable copy buttons, direction belongs on the buttons, and long candidate lists should scroll inside the panel.
